...
class Display(djbFrameBuffer):
    ...
    def init_display(self):
        ...
        self.write_cmd(MADCTL, const(b'\xA0'))        
       
        self.write_cmd(CASET, const(b'\x00\x50\x01\x3F'))  # Rotation 270° 80 , 319
        self.write_cmd(RASET, const(b'\x00\x00\x00\xEF'))  # Rotation 270° 0 , 239
    ...
    def init_frame(self):
        ws = ((240 - self.width)//2)+80
        we = 239 - ((240 - self.width)//2)+80
